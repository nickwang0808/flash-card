...
- Integration tests: `DATABASE_URL=... npm run test:integration` — caller suites, schema checks, and live HTTP smoke.
- Web build: `npm run build` — Expo static export of the current stub screen.
